			...
			{fbvFormSection id='schedulePublicationDiv' list="false"}
				...
				{fbvFormArea id="schedulingInformationDatePublished" title="publication.datePublished"}
					{fbvFormSection for="publishedDate"}
						{fbvElement type="text" id="datePublished" value=$datePublished translate=false label="publication.datePublished" inline=true size=$fbvStyles.size.MEDIUM class="datepicker"}
					{/fbvFormSection}
				{/fbvFormArea}
