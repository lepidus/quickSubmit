...
/**
 * @file controllers/grid/chapter/QuickChapterGridHandler.inc.php
 *
 * Copyright (c) 2014-2020 Simon Fraser University
 * Copyright (c) 2000-2020 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class QuickChapterGridHandler
...
import('controllers.grid.users.chapter.QuickChapterGridCategoryRow');

// Link action & modal classes
import('lib.pkp.classes.linkAction.request.AjaxModal');

class QuickChapterGridHandler extends CategoryGridHandler {
	/** @var boolean */
	var $_readOnly;
	...
	function getCategoryRowInstance() {
		...
		$row = new QuickChapterGridCategoryRow($monograph, $this->getPublication(), $this->getReadOnly());
		import('controllers.grid.users.chapter.QuickQuickChapterGridCategoryRowCellProvider');
		$row->setCellProvider(new QuickQuickChapterGridCategoryRowCellProvider());
		return $row;
	}
	...
	function editChapter($args, $request) {
		...
		return new JSONMessage(true, $templateMgr->fetch('controllers/grid/chapter/editChapter.tpl'));
	}
