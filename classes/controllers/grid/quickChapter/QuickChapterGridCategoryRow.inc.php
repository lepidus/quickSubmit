...
/**
 * @file controllers/grid/chapter/QuickChapterGridCategoryRow.inc.php
 *
 * Copyright (c) 2014-2020 Simon Fraser University
 * Copyright (c) 2000-2020 John Willinsky
 * Distributed under the GNU GPL v3. For full terms see the file docs/COPYING.
 *
 * @class QuickChapterGridCategoryRow
...
class QuickChapterGridCategoryRow extends GridCategoryRow {
	/** @var Monograph **/
	var $_monograph;
